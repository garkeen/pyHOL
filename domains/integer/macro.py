...
from syntax.logicops import Not  # noqa: F401
from syntax.numeral import Int, greater, less
from math import gcd
from framework.logic import apply_theorem  # macro -> macro emission is sanctioned
from kernel.theory import register_macro, get_theorem
from domains.integer.conv import (
    int_eval,
    collect_int_polynomial_coeff,
    norm_eq,
    simp_full,
