# NOTE: Z3-related tests are disabled (commented out) by request.
# They depend on the external Z3 solver / Z3 proof reconstruction and are
# not part of the regression baseline. Restore by uncommenting below.
