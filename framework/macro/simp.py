...
# (fixpoint loop). Moved here from framework/tactic.py in rewrite
...
# framework.auto -- the tactic<->auto import cycle is dissolved.
#
# The lazy `from framework import auto` below is the same-layer
# auto<->simp mutual recursion (solve, simplify, retry); both modules
# land in core/ at the step-9 rename.

from kernel import theory
from framework.conv import then_conv, top_conv, rewr_conv, beta_norm_conv
