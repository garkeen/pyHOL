...
MACRO_FILES = [
    'framework/macros/core.py',
    'framework/macros/z3.py',
    'framework/auto.py',
    'kernel/bootstrap.py',
    'domains/nat/macro.py',
    'domains/integer/macro.py',
    'domains/real/macro.py',
    'domains/logic/macro.py',
    'domains/expr/macro.py',
]
