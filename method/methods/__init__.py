...
from method.methods.core import apply_method, output_step, output_hint
from method.methods.core import ProofState
...
try:
    import method.methods.z3
except Exception as e:
    import sys
    print(f"Warning: failed to load method.methods.z3: {e}", file=sys.stderr)
