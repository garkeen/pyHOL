"""Replay target tables for the SAINT proof books.

Data only: expected closed forms for the exercises in each proof book.
"""
...
test_cases = {
    ...
    "UCDAVIS/Exponentials": {
        ...
        "Exercise 6" : "16/5 * exp(5) + exp(1) + 4 * exp(2) + 8 * exp(3) + 8 * exp(4) + -121/5",
    ...
    "UCDAVIS/LogAndArctangent": {
        ...
        "Exercise 16" : "-(log(exp(2) + 1) / 2) + exp(2) / 2 + log(2) / 2 + -1/2",
