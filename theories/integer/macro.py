...
from theories.integer.conv import int_norm_conv, int_eval, collect_int_polynomial_coeff, \
...
# The macros import their conv machinery from theories.integer.conv --
