...
from theories.nat import conv  # noqa: F401  (defines nat_eval_conv etc.)
from theories.nat import macro  # noqa: F401  (registers nat_eval, nat_norm, etc.)
from theories.nat import method  # noqa: F401  (registers nat_norm, nat_const_ineq methods)
