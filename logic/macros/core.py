...
# Import utility functions from logic.logic
from logic.logic import apply_theorem, conj_thms, get_forall_names, strip_all_implies, \
    strip_exists, strip_conj, strip_disj, imp_conj_iff, imp_disj_iff
...
# Import disj_norm and conj_norm from logic.logic
from logic.logic import disj_norm, conj_norm
